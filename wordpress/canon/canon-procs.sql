...
DROP PROCEDURE IF EXISTS get_branch_list;
DROP PROCEDURE IF EXISTS get_award_list;
DROP PROCEDURE IF EXISTS get_event_list;
DROP PROCEDURE IF EXISTS get_reign_list;
DROP PROCEDURE IF EXISTS get_person;
DROP PROCEDURE IF EXISTS get_branch;
DROP PROCEDURE IF EXISTS get_award;
DROP PROCEDURE IF EXISTS get_event;
DROP PROCEDURE IF EXISTS get_reign;
DROP PROCEDURE IF EXISTS get_person_name;
DROP PROCEDURE IF EXISTS get_branch_name;
DROP PROCEDURE IF EXISTS get_award_name;
DROP PROCEDURE IF EXISTS get_event_name;
DROP PROCEDURE IF EXISTS get_reign_name;
...
BEGIN
    SELECT award_name AS name,
           ...
           award_rank AS `rank`,
           award_precedence AS precedence,
           award_active AS active,
           award_branch AS branch_id,
           branch_name
      FROM canon_award
           LEFT OUTER JOIN canon_branch ON branch_id = award_branch
